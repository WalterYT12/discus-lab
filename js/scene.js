...
//
// THREE is passed in (rather than imported here with a static `import`
// statement) so that main.js can load it with a dynamic `import()` inside
// a try/catch. A static import failing (e.g. the CDN is unreachable)
// fails the ENTIRE module graph before any of our code runs, in a way
// that cannot be caught — only a dynamic import's rejected promise can
// be handled gracefully. See main.js for where THREE actually gets loaded.
