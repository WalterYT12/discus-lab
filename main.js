...
function applyDiscusAttitude(discusGroup, tiltAngleDeg, rollDeg) {
  ...
  // Negative sign: in Three.js with a Y-up flat disc, positive Z rotation
  // tilts the RIGHT edge down. Coaching.js defines positive rollDeg as
  // "left edge down" (tilt toward the favorable side for counteracting
  // crosswind drift), so we negate here to match that convention.
